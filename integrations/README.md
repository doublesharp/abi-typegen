...
| Unreal | [`AbiTypegen` plugin](unreal/Plugins/AbiTypegen/)                               | [Unreal bindings](../docs/native-bindings.md#unreal)               |
| Godot  | [GDExtension](godot/extension/)                                                 | [Godot bindings](../docs/native-bindings.md#godot)                 |
